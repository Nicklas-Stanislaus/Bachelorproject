...
def TS(fit_func, lims, dims, m = 4, n_neighbors = 10, h0 = 0.2, iterations = 10, visualize = False):
    ...
    for i in range(iterations):
        ...
        h_prev = h0
        # Inner boundary point to sample from 
        bound_point = h0
        ...
        for _ in range(n_neighbors): 
            ...
            while not point_selected: 
                ...
                neighbor = np.random.uniform(low = bound_point, high = bound_point + h_current) * u + x
            ...
            # set new h_prev and boundary point
            h_prev = h_current
            bound_point += h_current 
